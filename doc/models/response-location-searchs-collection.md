...
|  --- | --- | --- | --- | --- | --- |
| `type` | [`?string(Type31Enum)`](../../doc/models/type-31-enum.md) | Optional | Resource Type<br><br>**Default**: `Type31Enum::LOCATIONSEARCHSCOLLECTION` | getType(): ?string | setType(?string type): void |
